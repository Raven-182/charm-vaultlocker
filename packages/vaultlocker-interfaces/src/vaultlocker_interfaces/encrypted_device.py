...
class EncryptedDeviceRequires(Object):
    ...
    def set_device_results(
        ...
        relation.data[self.model.unit][DEVICE_RESULTS_FIELD] = serialize_device_results(
            results
        )
...
class EncryptedDeviceProvides(Object):
    ...
    def set_device_requests(
        ...
        relation.data[self.model.unit][DEVICE_REQUESTS_FIELD] = serialize_device_requests(
            requests
        )
